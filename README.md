#### Note: These instructions have been tested be in Google Cloud Platform Kubernetes Engine and IBM Cloud Container service.  I hope that they work everywhere else, and I will test them in other places as I am able.
